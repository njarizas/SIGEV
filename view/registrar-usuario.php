    ...
    <div class="row">
        ...
        if (isset($_POST['registrar'])) {
            ...
            if ($usuarioDAO->insertar($usuario) > 0) {
                echo "<script>alert('El usuario\"" . $usuario. "\" se registro exitosamente');</script>";
            }
        }
        $idtipoDoc = "";
        $documento = "";
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <form id="form_registrar_usuario" method="post" class="form-horizontal" action="registrar-usuario.php">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select for="tipoDoc" name="tipoDoc" >
                            <option value="" disabled selected>Seleccione tipo de documento</option>
                            <?php
                            foreach ($tipoDoc as $fila) {
                                echo '<option value="?= $tipoDoc; ? ' . $fila['idtipodocumento'] . '">' . $fila['nombredocumento'] . '</option>';
                            }
                            ?>
                        </select>
                    </div>
