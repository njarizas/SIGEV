...
if (count($usuarioslis) > 0) {
    echo '<div class="row"><div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3"><table border="1" class="table table-hover"><tr><td>Documento</td><td>Nombres</td></tr>';
}
foreach ($usuarioslis as $fila) {
    echo '<tr><td>' . $fila['documento'] . '</td>';
    echo '<td>' . $fila['nombres'] . '</td></tr>';
}
echo '</table></div></div>';
?>
</div >
        ...
        $('#form_registrar_usuario') . formValidation({
            ...
            contrasena: {
                ...
                '.col-sm-5',
                    ...
                    notEmpty: {
                        message:
                        'La contraseña debe ser alfanúmerica y mínimo 8 caracteres'
                                },
                    stringLength: {
                        min:
                        8,
            ...
            confircontrasena: {
                ...
                '.col-sm-5',
                    ...
                    notEmpty: {
                        message:
                        'La confirmación no coincide con la contraseña registrada'
                                },
                    identical: {
                        field:
                        'contrasena',
